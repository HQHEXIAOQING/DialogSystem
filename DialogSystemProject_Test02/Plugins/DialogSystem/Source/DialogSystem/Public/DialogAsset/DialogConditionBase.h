...
public:
	//条件判断(是否成立？)
	virtual bool DialogNodeConditionIsSucceed(UDialogAsset* SettingDialogAsset,UDialogNodeInfoBase* LastDialogNode,UDialogNodeInfoBase* NextDialogNode) {return BlueprintDialogNodeConditionIsSucceed(SettingDialogAsset,LastDialogNode,NextDialogNode);}
	UFUNCTION(BlueprintImplementableEvent,DisplayName="条件判断扩展",Category="DialogPacketConditionBase")
	bool BlueprintDialogNodeConditionIsSucceed(UDialogAsset* SettingDialogAsset,UDialogNodeInfoBase* LastDialogNode,UDialogNodeInfoBase* NextDialogNode);
};
