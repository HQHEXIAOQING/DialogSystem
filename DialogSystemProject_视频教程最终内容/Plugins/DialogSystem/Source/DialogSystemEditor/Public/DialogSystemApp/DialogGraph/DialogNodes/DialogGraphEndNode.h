...
public:
	...
	{
		RuntimeNodeInfo = NewObject<URuntimeDialogEndNodeInfo>(Outor);
	...
	//获取当前类型
	virtual EDialogNodeType GetDialogNodeType()const override{return EDialogNodeType::DialogEndNode;}

	virtual URuntimeDialogEndNodeInfo* GetRuntimeEndNodeInfo()const{return Cast<URuntimeDialogEndNodeInfo>(RuntimeNodeInfo);}
